...
def scf(coeffs):
    alpha_elec, beta_elec, alpha_prot, beta_prot = coeffs
    verbose = False
    elec_basis = [Gaussian_basis(COORDS[0], "optimize", d1=1, a1=alpha_elec*beta_elec**i) for i in range(6)]
    prot_basis = [Gaussian_basis(COORDS[0], "optimize", d1=1, a1=alpha_prot*beta_prot**i) for i in range(6)]
